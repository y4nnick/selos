...
class MainFuncs
{
    ...
    function processGridData($page,$limit,$sidx,$sord)
    {
        if(!$sidx) $sidx = 1;
        ...
        $result =$this->processReturnQuery("SELECT COUNT(*) as cnt FROM waterpoint_summary","dsw_db");
...
if(@$_GET['lst']=='y')
{
    ...
    $obj->processGridData($page,$limit,$sidx,$sord);
